...
export const deleteCustomerAction = (userId) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`https://hungrymeals-backend.onrender.com/api/users/delete/customer/${userId}`)
...
export const updateCustomerName = (updatecustomername, userId) => async dispatch => {
    ...
    try {
        const response = await axios.put(`https://hungrymeals-backend.onrender.com/api/users/update/customer/name/${userId}`, updatecustomername)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const updateCustomerEmail = (updatecustomeremail, userId) => async dispatch => {
    ...
    try {
        const response = await axios.put(`https://hungrymeals-backend.onrender.com/api/users/update/customer/email/${userId}`, updatecustomeremail)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const updateCustomerPassword = (updatecustomerpassword, userId) => async dispatch => {
    ...
    try {
        const response = await axios.put(`https://hungrymeals-backend.onrender.com/api/users/update/customer/password/${userId}`, updatecustomerpassword)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const updateCustomerVerification = (updatecustomerverification, userId, val) => async dispatch => {
    ...
    if (val === true) {
        ...
        try {
            const response = await axios.put(`https://hungrymeals-backend.onrender.com/api/users/update/customer/verification/${userId}`, updatecustomerverification)
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
...
export const addUser = (user) => async dispatch => {
    ...
    try {
        const response = await axios.post('https://hungrymeals-backend.onrender.com/api/users/addcustomer', user)
        console.log(response);
