...
export const getAllNews = () => async dispatch => {
    ...
    try {
        ...
        const response = await axios.get('https://hungrymeals-backend.onrender.com/api/newsfeed/getallnews')
...
export const createNewsAction = (newNews) => async dispatch => {
    ...
    try {
        const response = await axios.post('https://hungrymeals-backend.onrender.com/api/newsfeed/post/news',newNews )
...
export const updateNewsAction = (updatenews, id) => async dispatch => {
    ...
    try {
        ...
        const response = await axios.put(`https://hungrymeals-backend.onrender.com/api/newsfeed/update/news/${id}`, updatenews)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const deleteNewsAction = (newsId) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`https://hungrymeals-backend.onrender.com/api/newsfeed/delete/news/${newsId}`)
