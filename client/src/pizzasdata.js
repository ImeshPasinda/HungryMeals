...
const pizzas = [
    {
        ...
        description: "Made with the goodness of 100% original mozzarella cheese, the Margherita pizza Domino’s is prepared using cheese as the only topping. You can double the fun by adding more cheese as a topping or a few favorite toppings of your choice.",
    },
    {
